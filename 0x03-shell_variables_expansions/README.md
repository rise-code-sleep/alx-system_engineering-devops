...
This project focuses on local and global variables, creating, updating and deleting shell variables, expansions and performing arithmetic operations with the **Shell**.
